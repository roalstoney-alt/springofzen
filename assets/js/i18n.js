(function () {
  ...
  const zh = {
    ...
    "Join": "加入",
    "Observatory": "觀察站",
    "Human State Observatory": "人類狀態觀察站",
    "Enter the Observatory": "進入觀察站",
    "Enter the Harbor": "進入港灣",
    "Become a Resident": "成為居民",
    "Build fewer things. Create deeper experiences.": "建造更少的東西，創造更深的體驗。",
    "The goal is to create a place people miss when they leave.": "目標是創造一個人離開後會想念的地方。",
    "What helps people return to themselves?": "什麼能幫助人回到自己？",
    "The Human State Observatory shares public observations about recovery, focus, creativity, and meaning in the Agent Era.": "人類狀態觀察站分享關於恢復、專注、創造與意義的公共觀察。",
    "Look what we discovered.": "看看我們發現了什麼。",
    "A resident is someone who returns.": "居民，是會回來的人。",
    "Leave a State Note": "留下狀態筆記",
    "Before session: how do you feel?": "場景之前：你感覺如何？",
    "After session: did anything shift?": "場景之後：有什麼改變嗎？",
    "Hold This State Note": "保存這則狀態筆記",
    "Return Tomorrow": "明天再回來",
    "The light is still on.": "灯还亮着。",
    "Enter quietly.": "安静地进入。",
    "A quiet place, if you need one.": "如果你需要，这里有一个安静的地方。",
    "Music, memory, and small observations for those who need to slow down.": "给需要慢下来的人：音乐、记忆和一些小小的观察。",
    "Enter": "进入",
    "Sound Off": "声音关闭",
    "Sound On": "声音开启",
    "Stay": "停留",
    "Tonight's Harbor": "今晚的港湾",
    "The Harbor opens tonight.": "港湾今晚开放。",
    "A slow room for those still awake. No need to explain everything. Just listen for a while.": "给还醒着的人，一个缓慢的房间。不必解释所有事。先听一会儿。",
    "AI can give us time, but it cannot tell us how to live.": "AI 可以把时间还给我们，但它不能告诉我们该如何生活。",
    "That part is still our choice.": "那一部分，仍然是我们的选择。",
    "Leave a Harbor Note": "留下一则港湾笔记",
    "What did this place feel like?": "这个地方给你的感觉是什么？",
    "One word": "一个词",
    "Would you come back?": "你会回来吗？",
    "Yes": "会",
    "Maybe": "也许",
    "No": "不会",
    "What should be quieter, warmer, or more alive?": "什么应该更安静、更温暖，或者更有生命感？",
    "Did it feel like a real place?": "它像一个真实的地方吗？",
    "Leave Note": "留下笔记",
    "Your note is held here.": "你的笔记已被留在这里。",
    "Choose Your Harbor": "选择你的港湾",
    "When machines move faster, find somewhere slower.": "当机器移动得更快，去找一个更慢的地方。",
    "One warm room inside the machine world.": "机器世界里的一间温暖房间。",
    "Enter Slowly": "慢慢进入",
    "Read the Question": "阅读这个问题",
    "Warm light, soft air, and a place to begin again.": "温暖的光、柔软的空气，以及一个重新开始的地方。",
    "Enter Garden": "进入花园",
    "A dock, a light, and enough quiet to choose the next direction.": "一座码头、一盏灯，以及足够的安静，让你选择下一个方向。",
    "Read Today": "阅读今日",
    "A quiet room for breath, water, and attention returning to the body.": "一个安静的房间，让呼吸、水声和注意力回到身体。",
    "What should humans do with the time machines return?": "人类应该如何使用机器归还的时间？",
    "A quiet study for the question behind the work.": "一个安静的书房，留给工作背后的问题。",
    "Read": "阅读",
    "Human Harbor": "人類港灣",
