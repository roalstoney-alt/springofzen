(function () {
  ...
  const zh = {
    ...
    "Come in quietly.": "安静地进来。",
    "Someone left the door open.": "有人把门留开了。",
    "Stay as long as you need.": "你需要多久，就停多久。",
    "The room is quiet tonight.": "今晚房间很安静。",
    "No need to explain why you came.": "不必解释你为什么来到这里。",
    "Listen to the room": "聆听这个房间",
    "Let the room fall quiet": "让房间安静下来",
    "For those who came to listen": "给那些前来聆听的人",
    "For those watching hidden motion": "给那些观看隐秘流动的人",
    "For those who followed a light": "给那些跟随一束光而来的人",
    "For those studying the age of agents": "给那些研究智能代理时代的人",
    "For those building quietly": "给那些安静建造的人",
    "For those who only need one sentence": "给那些只需要一句话的人",
    "Motion": "流动",
    "View": "景",
    "Agents": "代理",
    "Craft": "手艺",
    ...
    "Harbor Views": "港湾景象",
    "For those who followed a light.": "给那些跟随一束光而来的人。",
    "A quiet window for landscape, room, water, and return.": "一扇安静的窗，留给风景、房间、水与回返。",
    "Window": "窗",
    "A warm room beside still water.": "静水旁的一间温暖房间。",
    "Some people do not arrive through a question. They arrive through an image that gives the mind somewhere to rest.": "有些人不是通过问题抵达。他们通过一幅让心智可以停靠的画面抵达。",
    "Enter the mountain room": "进入山中房间",
    "Dock": "码头",
    "The lake moves before the answer does.": "湖水先于答案流动。",
    "Stay with the motion long enough for the next direction to appear without force.": "和这份流动待久一点，让下一个方向自然出现。",
    "Quiet Craft": "安静手艺",
    "Small tools, repeatable rituals, and practical mastery without noise.": "小工具、可重复的仪式，以及没有噪音的实践掌握。",
    "Practice": "练习",
    "Build from the state you want to protect.": "从你想保护的状态开始建造。",
    "A useful tool should help attention become steadier, not louder.": "有用的工具应该让注意力更稳定，而不是更吵。",
    "Begin with one sentence": "从一句话开始",
    "Notebook": "笔记本",
    "Keep the work close to the human hand.": "让工作靠近人的手。",
    "Prompts, systems, and agents are welcome here only when they leave the room more alive.": "提示词、系统与代理只有在让房间更有生命感时，才被欢迎进入这里。",
    "Read the Agent Era note": "阅读智能代理时代笔记",
    "Enter quietly.": "安静地进入。",
    ...
    "A slow room for those still awake.": "给还醒着的人，一个缓慢的房间。",
    "A slow room for those still awake. No need to explain everything. Just listen for a while.": "给还醒着的人，一个缓慢的房间。不必解释所有事。先听一会儿。",
    "Today's Observation": "今日观察",
    "AI can give us time.": "AI 可以把时间还给我们。",
    "But it cannot tell us": "但它不能告诉我们",
    "what to do with the silence.": "该如何使用这份安静。",
    ...
    "Leave a note for the room.": "给这个房间留一张便条。",
    "A few words are enough.": "几句话就够了。",
    "What did this place feel like?": "这个地方给你的感觉是什么？",
    "One word": "一个词",
    "One word.": "一个词。",
    "One word...": "一个词...",
    "Would you come back?": "你会回来吗？",
    "Would you return?": "你会回来吗？",
    "Yes": "会",
    "Maybe": "也许",
    "No": "不会",
    "What should be quieter, warmer, or more alive?": "什么应该更安静、更温暖，或者更有生命感？",
    "What should become quieter, warmer, or more alive?": "什么应该变得更安静、更温暖，或者更有生命感？",
    "Write freely...": "自由写下...",
    "Did it feel like a real place?": "它像一个真实的地方吗？",
    "Leave Note": "留下笔记",
    "Your note is held here.": "你的笔记已被留在这里。",
    "Your note stays with the Harbor.": "你的便条会留在港湾里。",
    "Hidden paths": "隐藏的小路",
    "Latest Listening Room": "最新聆听房间",
    "Daily Harbor": "每日港湾",
    "Previous Night": "前一夜",
    "Listening Notes": "聆听笔记",
    "Harbor Note": "港湾笔记",
    "This room is made from five quiet layers:": "这个房间由五层安静组成：",
    "Room Notes": "房间笔记",
    "Tonight's Room": "今晚的房间",
    ...
    "A quiet observatory for how people recover, focus, and return.": "一個安靜的觀察站，留給人如何恢復、專注與回來。",
    ...
    "Listen": "聆聽",
    "Listening Notes": "聆聽筆記",
    "Feedback": "回饋",
    "How did this session affect you?": "這個場景如何影響了你？",
    "Harbor Note": "港灣筆記",
    "A few words are enough.": "幾句話就夠了。",
